				...
				<div id="header-text-nav-wrap" class="clearfix">
                  ...
                  if ( get_theme_mod( 'colormag_header_logo_placement', 'header_text_only' ) == 'header_logo_only' || (get_theme_mod( 'colormag_header_logo_placement', 'header_text_only' ) == 'disable' )) {
					...
					<div id="header-right-section">
						...
						<div id="header-right-sidebar" class="clearfix">
							<aside class="widget widget_search clearfix" id="search-4"><form method="get" class="search-form searchform clearfix" action="http://www.vintagejewelryshopping.com/">
							   <div class="search-wrap">
								  <input type="text" name="s" class="s field" placeholder="Search">
